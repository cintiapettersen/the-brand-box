...
async function analyzeImage(file) {
  ...
  const response = await ai.models.generateContent({
    ...
    contents: [
      `Does this illustration show both a man and a woman (a couple/parents) in a hospital or bedroom setting, with a baby?
...
async function run() {
  ...
  console.log(`Checking all ${files.length} images for a man, woman, and baby together in a room...`);
