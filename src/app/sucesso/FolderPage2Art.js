  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', fontFamily: 'Montserrat,sans-serif', boxSizing: 'border-box', padding: '3px 5px 4px', gap: '2.5px', background: '#f8f8f8', overflow: 'hidden' }}>
      ...
      <div style={{ background: c0, borderRadius: '3px', padding: '0.8px 3px', textAlign: 'center', flexShrink: 0 }}>
        <div style={{ fontSize: '4.1px', fontWeight: 900, color: textColor(c0), textTransform: 'uppercase', letterSpacing: '0.4px', fontFamily: 'Montserrat,sans-serif' }}>Alimentação Complementar</div>
        <div style={{ fontSize: '2.7px', color: textColor(c0), opacity: 0.85, marginTop: '0.5px', fontStyle: 'italic' }}>De forma lenta e gradual, respeitando a vontade da criança</div>
      </div>
      ...
      <div style={{ background: '#fff', border: `0.5px solid ${c0}40`, borderRadius: '3px', overflow: 'hidden', flexShrink: 0 }}>
        <div style={{ background: c0, padding: '1px 3px', display: 'flex' }}>
          <span style={{ flex: 1, fontSize: '3px', fontWeight: 900, color: textColor(c0), textTransform: 'uppercase', fontFamily: 'Montserrat,sans-serif' }}>Faixa Etária</span>
          <span style={{ flex: 1.6, fontSize: '3px', fontWeight: 900, color: textColor(c0), textTransform: 'uppercase', fontFamily: 'Montserrat,sans-serif' }}>Tipo de Alimento</span>
        </div>
        {faixas.map((row, i) => (
