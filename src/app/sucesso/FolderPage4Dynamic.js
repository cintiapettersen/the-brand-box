  ...
  return (
    <div style={{ width: '148px', height: '210px', position: 'absolute', top: 0, left: 0, overflow: 'hidden', pointerEvents: 'none' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, background: '#FAFAF8' }}>
        ...
        {/* Tabela 1: linhas coloridas (label=c3, valor=c4) */}
        ...
        {/* Tabela 2: colunas coloridas (c5 | c3 | c4) — largura total */}
        ...
        {[1,2,3].map(i => (
          <div key={i} style={{ position: 'absolute', top: `${53.8 + 4.7 + i * 8.7}%`, left: '7%', width: '86%', height: '0.4px', background: 'rgba(255,255,255,0.35)' }} />
        ))}
        <div style={{ position: 'absolute', top: '53.8%', left: `calc(7% + 86% * 0.27)`, width: '0.4px', bottom: '2%', background: 'rgba(255,255,255,0.35)' }} />
        <div style={{ position: 'absolute', top: '53.8%', left: `calc(7% + 86% * 0.54)`, width: '0.4px', bottom: '2%', background: 'rgba(255,255,255,0.35)' }} />
      </div>
